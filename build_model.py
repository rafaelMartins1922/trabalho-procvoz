...
# Unpack the example into audio and labels
example_audio, example_labels = example
...
example = next(iter(train_spectrogram_ds.take(1)))

# Unpack the example into audio and labels
example_spectrograms, example_spect_labels = example
